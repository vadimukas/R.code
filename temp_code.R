...
# Ten Up-To-Date Ways to do Common Data Tasks in R with Penguins dataset
...
# 3. Controlling mutated column location - adding penguin id 
...
# summarizing the models stats with broom
library(broom)
...
# or shorter version using nest_by
