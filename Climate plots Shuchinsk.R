...
#View(Shuchinsk_Ta)
tiff(file = "plot138.tiff", width = 18, height=8, units="in", res=600 )
par(mfrow = c(2,5), cex.main=1.2, cex.lab=1.2, cex.axis=1.3, lwd=1.2,par(mgp=c(2.5,1,0)))

# Linear regression models
# Tair annual Shuchisk with trendline

plot(Shuchinsk_Ta$Years, Shuchinsk_Ta$Temp, type="l", main = "Temp air annual Shuchinsk", ylab = expression(paste("Temperature (",degree,"C)")),xlab = '', col='red', ylim = c(-2,5))
...
# winter
plot(Shuchinsk_Ta$Years, Shuchinsk_Ta$DJF, type="l", main = "Temp air DJF  Shuchinsk", ylab = expression(paste("Temperature (",degree,"C)")),xlab = '', col='blue', ylim = c(-10,-25), size=5)
...
r2 <- round(summary(trend_lm)$r.squared, 4)
eqn<-bquote(r^2 == .(r2))
text(x=1990, y=-22, eqn, pos=4, cex=1.4)
summary (trend_lm)

# spring
plot(Shuchinsk_Ta$Years, Shuchinsk_Ta$MAM, type="l", main = "Temp air MAM  Shuchinsk", ylab = expression(paste("Temperature (",degree,"C)")),xlab = '', col='green', ylim = c(-5,10), size=3)
...
# summer
plot(Shuchinsk_Ta$Years, Shuchinsk_Ta$JJA, type="l", main = "Temp air JJA  Shuchinsk",ylab = expression(paste("Temperature (",degree,"C)")),xlab = '', col='red', ylim = c(12.5,22.5), size=3)
...
r2 <- round(summary(trend_lm)$r.squared, 4)
eqn<-bquote(r^2 == .(r2))
text(x=1990, y=21.5, eqn, pos=4, cex=1.4)
summary (trend_lm)


# autumn
plot(Shuchinsk_Ta$Years, Shuchinsk_Ta$SON, type="l", main = "Temp air SON  Shuchinsk", ylab = expression(paste("Temperature (",degree,"C)")),xlab = '', col='brown', ylim = c(-5,5), size=10)
...
r2 <- round(summary(trend_lm)$r.squared, 4)
eqn<-bquote(r^2 == .(r2))
text(x=1990, y=-3, eqn, pos=4,cex=1.4)
summary (trend_lm)
...
plot(Shuchinsk_Pa$Years, Shuchinsk_Pa$P, type="l", main = "Precip annual Shuchinsk", ylab = 'Precipitation, (mm)', xlab = '', col='red', ylim = c(150,650), size=10)
...
# winter
plot(Shuchinsk_Pa$Years, Shuchinsk_Pa$DJF, type="l", main = "Precip DJF  Shuchinsk", ylab = 'Precipitation, (mm)', xlab = '', col='blue', ylim = c(5,100), cex=1.2)
...
# spring
plot(Shuchinsk_Pa$Years, Shuchinsk_Pa$MAM, type="l", main = "Precip MAM  Shuchinsk", ylab = 'Precipitation (mm)', xlab = '', col='green', ylim = c(15,150), size=3)
...
r2 <- round(summary(trend_lm)$r.squared, 4)
eqn<-bquote(r^2 == .(r2))
text(x=1990, y=130, eqn, pos=4,cex=1.4)
summary (trend_lm)

# summer
plot(Shuchinsk_Pa$Years, Shuchinsk_Pa$JJA, type="l", main = "Precip JJA  Shuchinsk", ylab = 'Precipitation (mm)', xlab = '', col='red', ylim = c(15,400),size=3)
...
r2 <- round(summary(trend_lm)$r.squared, 4)
eqn<-bquote(r^2 == .(r2))
text(x=1990, y=350, eqn, pos=4, cex=1.4)
summary (trend_lm)
...
r2 <- round(summary(trend_lm)$r.squared, 4)
eqn<-bquote(r^2 == .(r2))
text(x=1990, y=140, eqn, pos=4, cex=1.4)
summary (trend_lm)
dev.off()
