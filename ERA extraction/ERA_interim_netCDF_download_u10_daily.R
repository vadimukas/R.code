...
u10<- brick("ERA 10 metre V wind component_2013-2016.nc")
u10
...
plot(date,u10_shuchinsk, type="l", col='red')

# write output in txt file
write.table(u10_shuchinsk, file = 'u10_v_shuchinks_2013-2016', sep = ',')